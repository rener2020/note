...
$$
\begin{cases}
\dot{e} = -A_0f - k_1sig^{\alpha_1}(e) - A_tf + A_0f \\
\dot{f}=k_2A_0^Tsig^{\alpha_2}(e) + k_2A_t^Tsig^{\alpha_2}(e) - k_2A_0^Tsig^{\alpha_2}(e)
\end{cases}
$$
则系统的标称部分为
...
$$
因此，系统的标称部分平衡点是全局渐进稳定的。此外，针对该标称系统当选取扩张$(\tau_1,\tau_1,\tau_1,\tau_1,\tau_1,\tau_1,\tau_2,\tau_2,\tau_2,\tau_2,\tau_2,\tau_2)=(1,1,1,1,1,1,\alpha_1,\alpha_1,\alpha_1,\alpha_1,\alpha_1,\alpha_1)$，系统具有负的齐次度$k=1-\cfrac{1}{\alpha_1}$。